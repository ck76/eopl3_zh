...
\newenvironment{EoplFigure}[1][htp]{\clearpage\begin{figure}[#1]\begin{longfbox}[border-width=1pt, border-left-width=0pt, border-right-width=0pt]\begin{small}}{\end{small}\end{longfbox}\end{figure}\clearpage}
